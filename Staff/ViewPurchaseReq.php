...
<section class="w3l-bottom-grids-6 py-5" id="features">
    <div class="container py-md-5 py-4">
        <div class="title-heading-w3 text-center mb-sm-5 mb-4">
            <h5 class="title-small mb-1">New</h5>
            <h3 class="title-style">Purchase Request</h3>
        </div>
        <div class="row">

            <?php
            include '../dbconnection.php';
            $qry = mysqli_query($conn, "SELECT DISTINCT u.* FROM `cart` c,`product` p,`user` u WHERE c.`uid`=u.`uid` AND c.`pid`=p.`pid` AND c.`status`='Paid'");
            ...
            ?>
                    ...
                    <div class="col-lg-3 col-md-6 grids-feature mt-md-0 mt-4" style="margin-bottom: 25px">
                        <div class="area-box">
                            ...
                            <a href="PurchaseRequestById.php?uid=<?php echo $row['uid'] ?>" class="btn more p-0">More Details<i class="fas fa-long-arrow-alt-right ms-1"></i></a>
                        </div>
                    </div>
