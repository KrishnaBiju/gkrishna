...
<section class="w3l-aboutblock1 pt-lg-5 pt-2 pb-5" id="about">
    <div class="container py-md-5 py-4">
        ...
        $id = $_GET['id'];
        $qry = mysqli_query($conn, "SELECT l.`lid`,u.* FROM `login` l,`user` u WHERE l.`uid`=u.`uid` AND l.`status`='Pending' AND l.`lid`='$id'");
        ...
        ?>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-8 ps-lg-5 mt-lg-0 mt-5">
                        ...
                        <a href="../Action/ApproveUser.php?id=<?php echo $row['lid'] ?>" class="btn btn-style mt-5">Approve</a>
                        <a href="../Action/RejectRequest.php?id=<?php echo $row['lid'] ?>" class="btn btn-style mt-5">Reject</a>
                    </div>
                </div>
