...
<section class="w3l-bottom-grids-6 py-5" id="features">
    <div class="container py-md-5 py-4">
        <div class="title-heading-w3 text-center mb-sm-5 mb-4">
            ...
            <h3 class="title-style">User Request</h3>
        </div>
        <div class="row">

            <?php
            include '../dbconnection.php';
            $qry = mysqli_query($conn, "SELECT l.`lid`,u.* FROM `login` l,`user` u WHERE l.`uid`=u.`uid` AND l.`status`='Pending'");
            ...
            ?>
                    ...
                    <div class="col-lg-3 col-md-6 grids-feature mt-md-0 mt-4" style="margin-bottom: 25px">
                        <div class="area-box">
                            ...
                            <a href="ViewUserById.php?id=<?php echo $row['lid'] ?>" class="btn more p-0">More Details<i class="fas fa-long-arrow-alt-right ms-1"></i></a>
                        </div>
                    </div>
